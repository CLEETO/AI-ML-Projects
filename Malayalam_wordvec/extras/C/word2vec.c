...
// initializing the network for the model. It defines all the input output and hidden leayers and initializes all the weights to 
//random small values and also calls CreateBinaryTree() to create the huffman binary tree of the vocabulary
void InitNet() {
  long long a, b;
...
// It uses both hierarchial softmax and 
